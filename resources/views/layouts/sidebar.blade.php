<div class="sidebar min-h-screen">
    <div class="flex">
        ...
        <div class="text-white text-[11px] ml-3">
            <p>Enterprise</p>
            <p>Resource</p>
            <p>Planning</p>
        </div>
    </div>
    <div class="w-full pl-9 mt-3.5">
        <ul>
